      ...
      <Card padding="lg" shadow="none" className="bg-bg-surface">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="max-w-2xl">
            <h1 className="text-h1 tracking-tight">Presupuestos</h1>
            <p className="mt-2 text-body text-content-secondary">
              Listado de presupuestos en modo solo lectura para revisar importes, márgenes y estado actual.
            </p>
          </div>
              ...
              >
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
                  <div>
                    ...
                    <p className="mt-1 text-h3 text-content-primary">
