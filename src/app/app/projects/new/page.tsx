    ...
    return (
      <section className="mx-auto flex w-full max-w-3xl flex-col gap-6">
        ...
        <EmptyState
          ...
          description="No tienes permisos para crear obras."
        />
      </section>
    );
  }
      ...
      <Card className="border-[var(--border-subtle)] bg-[var(--bg-surface)] p-6 text-[var(--text-primary)] shadow-none">
        ...
        <form action={createProjectWithOptionalQuickClient} className="mt-6 space-y-6">
            ...
            <details className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-raised)] p-4">
              ...
              <div className="mt-4 space-y-4">
                <label className="flex items-center gap-2 text-sm">
                  <input type="checkbox" name="quickClientEnabled" />
                  Usar cliente rápido (en vez de seleccionar uno existente)
                </label>

                <div className="space-y-1">
                  <label
                    className="text-sm font-medium"
                    htmlFor="quickClientDisplayName"
                  >
                    Nombre del cliente
                  </label>
                  <input
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-xs text-[var(--text-tertiary)]">
              Tu organización se deriva de tu sesión (memberships). No se puede
