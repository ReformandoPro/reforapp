    ...
    return (
      <section className="mx-auto flex w-full max-w-3xl flex-col gap-6">
        <Card className="border-[var(--border-subtle)] bg-[var(--bg-surface)] p-6 text-[var(--text-primary)] shadow-none">
          ...
          <div className="mt-4">
            <Link
              href={`/login?redirectTo=/app/clients/${id}/edit`}
  ...
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      ...
      <Card className="border-[var(--border-subtle)] bg-[var(--bg-surface)] p-6 text-[var(--text-primary)] shadow-none">
        ...
        <form action={updateClient} className="mt-6 space-y-6">
          <input type="hidden" name="clientId" value={clientRow.id} />
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              name="display_name"
              required
              defaultValue={clientRow.display_name}
          ...
          <div className="space-y-1">
            ...
            <input
              id="address"
              name="address"
              defaultValue={clientRow.address ?? ""}
              className="w-full rounded-xl border border-subtle bg-bg-surface px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus"
            />
          </div>
